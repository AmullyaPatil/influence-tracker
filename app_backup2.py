...
def main():
    ...
    <div class="main-header">
        ...
        <p style="font-size: 1.2rem; margin-top: 0.5rem;">AI-Powered YouTube Trend Analysis for Brand Teams</p>
        <div style="margin-top: 1rem;">
            <span class="feature-badge">🤖 AI-Powered</span>
            <span class="feature-badge">📊 Real-time</span>
            <span class="feature-badge">🎯 Actionable Insights</span>
    ...
    <div class="ai-powered">
        🧠 Powered by Google Gemini AI + OpenAI GPT-4 | Real-time Trend Analysis | Executive Briefs
    </div>
    """, unsafe_allow_html=True)
    ...
    if all_posts:
        ...
        with success_metrics:
            ...
            <div class="metric-card success-animation">
                ...
                <p><strong>✅ Successfully processed {len(all_posts)} videos from {len(valid_channels)} channels</strong></p>
                <p>🚀 AI Analysis: {len(all_posts)} summaries generated</p>
                <p>📊 Trends Identified: {sum(len(post['trends'].split(',')) if post['trends'] else 0 for post in all_posts)}</p>
                <p>⏱️ Processing Time: Optimized with rate limiting</p>
            </div>
            """.format(len(all_posts), len(valid_channels)), unsafe_allow_html=True)
    else:
